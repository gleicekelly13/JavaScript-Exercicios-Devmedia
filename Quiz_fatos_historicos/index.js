...
const questoes = [
  ...
  function selecionarPerguntasAleatorias(questoes, quantidadePerguntas) {
    return questoes.sort(() => Math.random() - 0.5).slice(0, quantidadePerguntas);
  }
  ...
  function validaRespostaUsuario(respostaDoUsuario, pergunta) {
