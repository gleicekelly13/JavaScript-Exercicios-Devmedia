//Declaração das variáveis que armazenam as chuvas de meteoro
...
let mes_atual = data_atual.getMonth(); //Retorna o mês atual, que vai de 0 à 11

//Estrutura if capaz de identificar um trimestre a partir do número do mês
if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2) {
    //Imprime no console o resultado correspondente ao trimestre detectado
